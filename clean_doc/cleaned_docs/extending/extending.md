...
staticPyModuleDef_Slotspam_module_slots[]={
...
Python parser with a particular string as input, see The Very High Level Layer.)
...
staticstructPyModuleDefkeywdarg_module={
.m_base=PyModuleDef_HEAD_INIT,
.m_name="keywdarg",
.m_size=0,
