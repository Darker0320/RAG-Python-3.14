...
* `virtualenv` is a third-party alternative (and predecessor) to
  `venv`.
* The Python Package Index (PyPI) is a public
...
```
python-mpipinstallSomePackage==1.0.4# specific version
python-mpipinstall"SomePackage>=1.0.4"# minimum version
```
...
```
python3-mpipinstallSomePackage# default Python 3
python3.14-mpipinstallSomePackage# specifically Python 3.14
```
...
```
py-3-mpipinstallSomePackage# default Python 3
py-3.14-mpipinstallSomePackage# specifically Python 3.14
```
