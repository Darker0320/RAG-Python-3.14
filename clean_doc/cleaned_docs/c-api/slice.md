...
intPySlice\_GetIndices(PyObject\*slice, Py\_ssize\_tlength, Py\_ssize\_t\*start, Py\_ssize\_t\*stop, Py\_ssize\_t\*step)
*Part of the Stable ABI.*
...
intPySlice\_GetIndicesEx(PyObject\*slice, Py\_ssize\_tlength, Py\_ssize\_t\*start, Py\_ssize\_t\*stop, Py\_ssize\_t\*step, Py\_ssize\_t\*slicelength)
*Part of the Stable ABI.*
...
intPySlice\_Unpack(PyObject\*slice, Py\_ssize\_t\*start, Py\_ssize\_t\*stop, Py\_ssize\_t\*step)
...
Py\_ssize\_tPySlice\_AdjustIndices(Py\_ssize\_tlength, Py\_ssize\_t\*start, Py\_ssize\_t\*stop, Py\_ssize\_tstep)
*Part of the Stable ABI since version 3.7.*
