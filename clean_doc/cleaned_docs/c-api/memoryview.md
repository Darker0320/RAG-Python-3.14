...
PyTypeObjectPyMemoryView\_Type
...
PyObject\*PyMemoryView\_FromMemory(char\*mem, Py\_ssize\_tsize, intflags)
...
PyObject\*PyMemoryView\_FromBuffer(constPy\_buffer\*view)
...
PyObject\*PyMemoryView\_GetContiguous(PyObject\*obj, intbuffertype, charorder)
*Return value: New reference.* *Part of the Stable ABI.*
...
intPyMemoryView\_Check(PyObject\*obj)
