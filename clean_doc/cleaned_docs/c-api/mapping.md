...
intPyMapping\_Check(PyObject\*o)
...
Py\_ssize\_tPyMapping\_Size(PyObject\*o)

Py\_ssize\_tPyMapping\_Length(PyObject\*o)
*Part of the Stable ABI.*

    Returns the number of keys in object *o* on success, and `-1` on failure.
    This is equivalent to the Python expression `len(o)`.

PyObject\*PyMapping\_GetItemString(PyObject\*o, constchar\*key)
...
intPyMapping\_GetOptionalItem(PyObject\*obj, PyObject\*key, PyObject\*\*result)
...
intPyMapping\_GetOptionalItemString(PyObject\*obj, constchar\*key, PyObject\*\*result)
*Part of the Stable ABI since version 3.13.*
...
intPyMapping\_SetItemString(PyObject\*o, constchar\*key, PyObject\*v)
*Part of the Stable ABI.*
...
intPyMapping\_DelItem(PyObject\*o, PyObject\*key)
This is an alias of `PyObject_DelItem()`.

intPyMapping\_DelItemString(PyObject\*o, constchar\*key)
This is the same as `PyObject_DelItem()`, but *key* is
    specified as a constchar\* UTF-8 encoded bytes string,
    rather than a PyObject\*.

intPyMapping\_HasKeyWithError(PyObject\*o, PyObject\*key)
*Part of the Stable ABI since version 3.13.*
...
intPyMapping\_HasKeyStringWithError(PyObject\*o, constchar\*key)
*Part of the Stable ABI since version 3.13.*
...
intPyMapping\_HasKey(PyObject\*o, PyObject\*key)
*Part of the Stable ABI.*
...
intPyMapping\_HasKeyString(PyObject\*o, constchar\*key)
*Part of the Stable ABI.*
