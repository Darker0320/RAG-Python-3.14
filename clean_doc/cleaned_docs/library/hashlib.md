...
SHA1). Refer to Attacks on cryptographic hash algorithms and the
...
hashlib.sha3\_224([*data*, ]*\**, *usedforsecurity=True*)

hashlib.sha3\_256([*data*, ]*\**, *usedforsecurity=True*)

hashlib.sha3\_384([*data*, ]*\**, *usedforsecurity=True*)

hashlib.sha3\_512([*data*, ]*\**, *usedforsecurity=True*)
...
hashlib.shake\_128([*data*, ]*\**, *usedforsecurity=True*)

hashlib.shake\_256([*data*, ]*\**, *usedforsecurity=True*)
...
Return a digest object that has been updated with contents of file object.
    ...
    *fileobj* must be a file-like object opened for reading in binary mode.
    It accepts file objects from builtin `open()`, `BytesIO`
    ...
    from `fileno()` directly. *fileobj* must be assumed to be
    ...
    *digest* must either be a hash algorithm name as a *str*, a hash
    ...
    Changed in version 3.14: Now raises a `BlockingIOError` if the file is opened in non-blocking
...
The function provides PKCS#5 password-based key derivation function 2. It
    ...
    your application, read *Appendix A.2.2* of NIST-SP-800-132. The answers
    on the stackexchange pbkdf2 iterations question explain in detail.
...
hashlib.blake2b(*data=b''*, *\**, *digest\_size=64*, *key=b''*, *salt=b''*, *person=b''*, *fanout=1*, *depth=1*, *leaf\_size=0*, *node\_offset=0*, *node\_depth=0*, *inner\_size=0*, *last\_node=False*, *usedforsecurity=True*)

hashlib.blake2s(*data=b''*, *\**, *digest\_size=32*, *key=b''*, *salt=b''*, *person=b''*, *fanout=1*, *depth=1*, *leaf\_size=0*, *node\_offset=0*, *node\_depth=0*, *inner\_size=0*, *last\_node=False*, *usedforsecurity=True*)
