...
ipaddress.ip\_network(*address*, *strict=True*)
...
ipaddress.ip\_interface(*address*)
...
ipaddress.summarize\_address\_range(*first*, *last*)
...
ipaddress.collapse\_addresses(*addresses*)
...
ipaddress.get\_mixed\_type\_key(*obj*)
