...
py\_compile.compile(*file*, *cfile=None*, *dfile=None*, *doraise=False*, *optimize=-1*, *invalidation\_mode=PycInvalidationMode.TIMESTAMP*, *quiet=0*)
Compile a source file to byte-code and write out the byte-code cache file.
    ...
    If *doraise* is true, a `PyCompileError` is raised
    ...
    *invalidation\_mode* should be a member of the `PycInvalidationMode`
    ...
    Changed in version 3.7: The *invalidation\_mode* parameter was added as specified in **PEP 552**.
