...
available. See Virtual Environments and `site`’s
...
*class*venv.EnvBuilder(*system\_site\_packages=False*, *clear=False*, *symlinks=False*, *upgrade=False*, *with\_pip=False*, *prompt=None*, *upgrade\_deps=False*, *\**, *scm\_ignore\_files=frozenset()*)
The `EnvBuilder` class accepts the following keyword arguments on
    instantiation:

    * *system\_site\_packages* – a boolean value indicating that the system Python
    ...
    * *with\_pip* – a boolean value which, if true, ensures pip is
    ...
    * *upgrade\_deps* – Update the base venv modules to the latest on PyPI
    * *scm\_ignore\_files* – Create ignore files based for the specified source
...
venv.create(*env\_dir*, *system\_site\_packages=False*, *clear=False*, *symlinks=False*, *with\_pip=False*, *prompt=None*, *upgrade\_deps=False*, *\**, *scm\_ignore\_files=frozenset()*)
Create an `EnvBuilder` with the given keyword arguments, and call its
    `create()` method with the *env\_dir* argument.

    Added in version 3.3.

    Changed in version 3.4: Added the *with\_pip* parameter

    Changed in version 3.6: Added the *prompt* parameter

    Changed in version 3.9: Added the *upgrade\_deps* parameter

    Changed in version 3.13: Added the *scm\_ignore\_files* parameter
