...
* The Transports section documents asyncio `BaseTransport`,
  `ReadTransport`, `WriteTransport`, `Transport`,
  `DatagramTransport`, and `SubprocessTransport`
  classes.
...
BaseTransport.get\_extra\_info(*name*, *default=None*)
...
### is a non-empty bytes object containing the received data.
