...
```
$ python-mzipappmyapp-m"myapp:main"
$ pythonmyapp.pyz
<output from myapp>
```
...
zipapp.create\_archive(*source*, *target=None*, *interpreter=None*, *main=None*, *filter=None*, *compressed=False*)
...
zipapp.get\_interpreter(*archive*)
