...
**Source code:** Lib/string/\_\_init\_\_.py
...
String of ASCII characters which are considered printable by Python.
    ...
    printable in the POSIX sense (see *LC\_CTYPE*).
...
Given *field\_name*, convert it to an object to be formatted.
        Auto-numbering of *field\_name* returned from `parse()` is done by
        `vformat()` before calling this method. Returns a tuple (obj, used\_key).
        ...
        `vformat()`. The return value *used\_key* has the same meaning
