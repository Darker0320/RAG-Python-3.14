...
* **obj** (*object*) – The Python object to be serialized.
        ...
        * **check\_circular** (*bool*) – If `False`, the circular reference check for container types is skipped
          ...
          Default `True`.
        * **allow\_nan** (*bool*) – If `False`, serialization of out-of-range `float` values
        ...
        * **sort\_keys** (*bool*) – If `True`, dictionaries will be outputted sorted by key.
          Default `False`.
...
* **fp** (file-like object) – A `.read()`-supporting text file or binary file
        ...
        * **object\_hook** (callable | None) – If set, a function that is called with the result of
          ...
          Default `None`.
        * **object\_pairs\_hook** (callable | None) – If set, a function that is called with the result of
          ...
          Default `None`.
        * **parse\_float** (callable | None) – If set, a function that is called with
        ...
        * **parse\_int** (callable | None) – If set, a function that is called with
          ...
          for example `float`.
        * **parse\_constant** (callable | None) – If set, a function that is called with one of the following strings:
...
* **JSONDecodeError** – When the data being deserialized is not a valid JSON document.
    ...
    * *fp* can now be a binary file.
    ...
    Changed in version 3.11: The default *parse\_int* of `int()` now limits the maximum length of
