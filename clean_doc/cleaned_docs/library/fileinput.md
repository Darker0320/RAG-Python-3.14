...
Class `FileInput` is the implementation; its methods `filename()`,
    ...
    and has a `readline()` method which returns the next
...
fileinput.hook\_compressed(*filename*, *mode*, *\**, *encoding=None*, *errors=None*)
...
Returns a hook which opens each file with `open()`, using the given
    *encoding* and *errors* to read the file.
    ...
    Deprecated since version 3.10: This function is deprecated since `fileinput.input()` and `FileInput`
