...
*classmethod*float.from\_number(*x*)
...
*classmethod*complex.from\_number(*x*)
...
Return a string object containing two hexadecimal digits for each
        ...
        Changed in version 3.8: `bytes.hex()` now supports optional *sep* and *bytes\_per\_sep*
...
> Create a `memoryview` that references *object*. *object* must
    ...
    >
    > `memoryview`s are generic over the type of their
    > underlying data.
    >
...
frozenset.symmetric\_difference(*other*, */*)

set.symmetric\_difference(*other*, */*)
...
set.intersection\_update(*\*others*)

set &= other & ...
Update the set, keeping only elements found in it and all others.

set.difference\_update(*\*others*)

set -= other | ...
Update the set, removing elements found in others.

set.symmetric\_difference\_update(*other*, */*)
...
Enter the runtime context and return either this object or another object
    ...
    File objects return themselves from \_\_enter\_\_() to allow `open()` to be
