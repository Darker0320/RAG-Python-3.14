...
intPyIter\_NextItem(PyObject\*iter, PyObject\*\*item)
...
PySendResultPyIter\_Send(PyObject\*iter, PyObject\*arg, PyObject\*\*presult)
:   *Part of the Stable ABI since version 3.10.*
