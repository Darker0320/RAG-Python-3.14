...
Lib/asyncio/base\_subprocess.py
...
:   Create a subprocess.
    ...
    wrappers for `stdout` and `stderr`
...
:   Special value that can be used as the *stdin*, *stdout* or *stderr* argument
    ...
    `os.devnull` will be used for the corresponding subprocess stream.
...
:   An object that wraps OS processes created by the
    ...
    *async*communicate(*input=None*)
    ...
    :   Stop the child process.
        ...
        On POSIX systems this method sends `SIGTERM` to the
        child process.
    ...
    :   Return code of the process when it exits.
        ...
        For processes created with `create_subprocess_exec()`, a negative
