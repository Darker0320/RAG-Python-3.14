...
pkgutil.get\_importer(*path\_item*)
...
pkgutil.iter\_importers(*fullname=''*)
...
pkgutil.iter\_modules(*path=None*, *prefix=''*)
...
pkgutil.walk\_packages(*path=None*, *prefix=''*, *onerror=None*)
...
pkgutil.get\_data(*package*, *resource*)
...
pkgutil.resolve\_name(*name*)
:   Resolve a name to an object.

    This functionality is used in numerous places in the standard library (see
    bpo-12915) - and equivalent functionality is also in widely used
