...
```
fromxml.dom.pulldomimport parse
fromxml.saximport make_parser
fromxml.sax.handlerimport feature_external_ges
...
:   Return a `DOMEventStream` from the given input. *stream\_or\_string* may be
