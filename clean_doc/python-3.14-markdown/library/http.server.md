...
```
defrun(server_class=HTTPServer, handler_class=BaseHTTPRequestHandler):
    server_address = ('', 8000)
...
*class*http.server.HTTPSServer(*server\_address*, *RequestHandlerClass*, *bind\_and\_activate=True*, *\**, *certfile*, *keyfile=None*, *password=None*, *alpn\_protocols=None*)
...
*class*http.server.ThreadingHTTPSServer(*server\_address*, *RequestHandlerClass*, *bind\_and\_activate=True*, *\**, *certfile*, *keyfile=None*, *password=None*, *alpn\_protocols=None*)
:   This class is identical to `HTTPSServer` but uses threads to handle
    requests by inheriting from `ThreadingMixIn`. This is
...
:   This class is used to serve either files or output of CGI scripts from the
    ...
    Deprecated since version 3.13, will be removed in version 3.15: `CGIHTTPRequestHandler` is being removed in 3.15. CGI has not
...
:   `CGIHTTPRequestHandler` can be enabled in the command line by passing
    ...
    because `CGIHTTPRequestHandler` is being removed.
