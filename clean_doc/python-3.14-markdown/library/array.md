...
basic values: characters, integers, floating-point numbers. Arrays are mutable sequence
...
:   A new array whose items are restricted by *typecode*, and initialized
    ...
    frombytes(*buffer*, */*)
    :   Appends items from the bytes-like object, interpreting
    ...
    :   Extends this array with data from the given Unicode string.
        The array must have type code `'u'` or `'w'`; otherwise a `ValueError` is raised.
