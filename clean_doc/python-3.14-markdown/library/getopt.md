...
or else as features in the `argparse` module.
...
using the `argparse` module instead. Users who are familiar with the Unix
...
using the `optparse` module. See Choosing an argument parsing library for
additional details.
