...
asyncio.print\_call\_graph(*future=None*, */*, *\**, *file=None*, *depth=1*, *limit=None*)
...
asyncio.format\_call\_graph(*future=None*, */*, *\**, *depth=1*, *limit=None*)
:   Like `print_call_graph()`, but returns a string.
    If *future* is `None` and there’s no current task,
    the function returns an empty string.

asyncio.capture\_call\_graph(*future=None*, */*, *\**, *depth=1*, *limit=None*)
...
asyncio.future\_add\_to\_awaited\_by(*future*, *waiter*, */*)
...
asyncio.future\_discard\_from\_awaited\_by(*future*, *waiter*, */*)
