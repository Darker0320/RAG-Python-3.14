...
on what you’re trying to do. Recommended third party tools
...
`PyBytes_Check()`, `PyTuple_Check()`, `PyList_Check()`, etc.
...
this object to `sys.stdout` and `sys.stderr`. Call print\_error, or
...
## How do I find undefined g++ symbols \_\_builtin\_new or \_\_pure\_virtual?
